...
class EcPrivateKey extends AsymmetricKey {
    ...
    fromJSON(json) {
        ...
        keyInfo.privateKeyAlgorithm.parameters = asn1Schema.AsnSerializer.serialize(new core.asn1.ObjectIdentifier(getOidByNamedCurve$1(json.crv)));
...
class EcPublicKey extends AsymmetricKey {
    ...
    fromJSON(json) {
        ...
        keyInfo.publicKeyAlgorithm.parameters = asn1Schema.AsnSerializer.serialize(new core.asn1.ObjectIdentifier(getOidByNamedCurve$1(json.crv)));
...
class EcCrypto {
    ...
    static assertKeyParameters(parameters, namedCurve) {
        ...
        try {
            namedCurveIdentifier = asn1Schema.AsnParser.parse(parameters, core.asn1.ObjectIdentifier).value;
        }
        catch (e) {
    ...
    static async importPrivateKey(asnKey, algorithm, extractable, keyUsages) {
        const keyInfo = new core.asn1.PrivateKeyInfo();
        keyInfo.privateKeyAlgorithm.algorithm = "1.2.840.10045.2.1";
        keyInfo.privateKeyAlgorithm.parameters = asn1Schema.AsnSerializer.serialize(new core.asn1.ObjectIdentifier(getOidByNamedCurve$1(algorithm.namedCurve)));
        keyInfo.privateKey = asn1Schema.AsnSerializer.serialize(asnKey);
    ...
    static async importPublicKey(asnKey, algorithm, extractable, keyUsages) {
        ...
        keyInfo.publicKeyAlgorithm.parameters = asn1Schema.AsnSerializer.serialize(new core.asn1.ObjectIdentifier(namedCurve));
