...
class EcPrivateKey extends AsymmetricKey {
    ...
    fromJSON(json) {
        ...
        keyInfo.privateKeyAlgorithm.parameters = AsnSerializer.serialize(new asn1.ObjectIdentifier(getOidByNamedCurve$1(json.crv)));
...
class EcPublicKey extends AsymmetricKey {
    ...
    fromJSON(json) {
        ...
        keyInfo.publicKeyAlgorithm.parameters = AsnSerializer.serialize(new asn1.ObjectIdentifier(getOidByNamedCurve$1(json.crv)));
...
class EcCrypto {
    ...
    static assertKeyParameters(parameters, namedCurve) {
        ...
        try {
            namedCurveIdentifier = AsnParser.parse(parameters, asn1.ObjectIdentifier).value;
        }
        catch (e) {
    ...
    static async importPrivateKey(asnKey, algorithm, extractable, keyUsages) {
        const keyInfo = new asn1.PrivateKeyInfo();
        keyInfo.privateKeyAlgorithm.algorithm = "1.2.840.10045.2.1";
        keyInfo.privateKeyAlgorithm.parameters = AsnSerializer.serialize(new asn1.ObjectIdentifier(getOidByNamedCurve$1(algorithm.namedCurve)));
        keyInfo.privateKey = AsnSerializer.serialize(asnKey);
    ...
    static async importPublicKey(asnKey, algorithm, extractable, keyUsages) {
        ...
        keyInfo.publicKeyAlgorithm.parameters = AsnSerializer.serialize(new asn1.ObjectIdentifier(namedCurve));
...
class EdPrivateKey extends AsymmetricKey {
    ...
    getKey() {
        const keyInfo = AsnParser.parse(this.data, asn1.PrivateKeyInfo);
        return AsnParser.parse(keyInfo.privateKey, asn1.CurvePrivateKey);
    }
    toJSON() {
        const key = this.getKey();
        const json = {
    ...
    fromJSON(json) {
        ...
        const key = JsonParser.fromJSON(json, { targetSchema: asn1.CurvePrivateKey });
        keyInfo.privateKey = AsnSerializer.serialize(key);
        this.data = Buffer.from(AsnSerializer.serialize(keyInfo));
        return this;
    }
...
class EdCrypto {
    ...
    static async importKey(format, keyData, algorithm, extractable, keyUsages) {
        switch (format.toLowerCase()) {
            ...
            case "pkcs8": {
                const keyInfo = AsnParser.parse(new Uint8Array(keyData), asn1.PrivateKeyInfo);
                const asnKey = AsnParser.parse(keyInfo.privateKey, asn1.CurvePrivateKey);
                return this.importPrivateKey(asnKey, algorithm, extractable, keyUsages);
            }
            default:
                throw new OperationError("format: Must be 'jwk', 'raw', 'pkcs8' or 'spki'");
...
class SubtleCrypto extends SubtleCrypto$1 {
    constructor() {
        ...
        const nodeMajorVersion = (_a = /^v(\d+)/.exec(version)) === null || _a === void 0 ? void 0 : _a[1];
